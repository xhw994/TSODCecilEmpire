...
VALUES
    ('ABILITY_RECEIVE_TSOD_GORGON_PLATFORM_SIEGE_BONUS', 'RECEIVE_TSOD_GORGON_PLATFORM_SIEGE_BONUS');

INSERT INTO
    Modifiers (ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId)
VALUES
    ('GRANT_TSOD_SCOUT_AMBER', 'MODIFIER_PLAYER_GRANT_UNIT_IN_CAPITAL', 'PLAYER_HAS_CITY_CENTER_DISTRICT_REQUIREMENTS', NULL),
    ('RECEIVE_TSOD_GORGON_PLATFORM_SIEGE_BONUS', 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH', NULL, 'RECEIVE_TSOD_GORGON_PLATFORM_SIEGE_BONUS_REQS');
...
VALUES
    ...
    ('RECEIVE_TSOD_GORGON_PLATFORM_SIEGE_BONUS', 'Amount', '5');
...
VALUES
    ...
    ('RECEIVE_TSOD_GORGON_PLATFORM_SIEGE_BONUS_REQS', 'REQUIREMENTSET_TEST_ALL');
...
VALUES
    ...
    ('RECEIVE_TSOD_GORGON_PLATFORM_SIEGE_BONUS_REQS', 'ADJACENT_TSOD_GORGON_PLATFORM_REQ');
...
VALUES
    ...
    ('ADJACENT_TSOD_GORGON_PLATFORM_REQ', 'MaxRange', '2'),
    ('ADJACENT_TSOD_GORGON_PLATFORM_REQ', 'MinRange', '0'),
    ('ADJACENT_TSOD_GORGON_PLATFORM_REQ', 'UnitType', 'UNIT_TSOD_GORGON_PLATFORM');

INSERT INTO
    ModifierStrings (ModifierId, Context, Text)
VALUES
    ('RECEIVE_TSOD_GORGON_PLATFORM_SIEGE_BONUS', 'Summary', 'LOC_ABILITY_RECEIVE_TSOD_GORGON_PLATFORM_SIEGE_BONUS_DESCRIPTION'),
    ('RECEIVE_TSOD_GORGON_PLATFORM_SIEGE_BONUS', 'Preview', 'LOC_ABILITY_RECEIVE_TSOD_GORGON_PLATFORM_SIEGE_BONUS_MODIFIER_DESCRIPTION');