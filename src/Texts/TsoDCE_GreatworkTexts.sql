...
VALUES
	...
	(
		...
		'zh_Hans_CN',
		'这座城里，百分之九十九的人都是移民，或者说是流民、难民。[NEWLINE]他们经历过故事里的一切——背井离乡，漫长的旅途，在陌生的土地上扎根，工作，建造属于自己的房屋，耕种属于自己的土地……[NEWLINE]没有哪个故事，能如《移民》一般打动坐在这里的人。'
	),
	('LOC_GREATWORK_TSOD_CE_BEACON_FIRE_NAME', 'zh_Hans_CN', '《烽火》'),
	(
